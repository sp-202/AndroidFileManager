...
public class FlieList_Adapter extends RecyclerView.Adapter<FlieList_Adapter.File_ListViewHolder> {
    Context context;
    File[] filesAndFolders;

    public FlieList_Adapter(Context context, File[] filesAndFolders) {
